...
dataset:
  citation:
      title: "Social Data Commons: Obgyn Access VA"
      subtitle: ""
      dsDescriptionValue: "Catchment areas for ObGyn in VA at the Census Tract level"
...
if (file.exists(here::here("data/dataset_doi"))) {
  ...
  if (is.na(dataset_doi)) {
    ...
    doi <- ds_info$data$persistentId
    writeLines(doi, here::here("data/dataset_doi"))
    save(doi, file = here::here("R/sysdata.rda"))
