...
write.csv(dmv_bg_2021_acccess_scores_obgyn, "dmv_cttrbg_webmd_2021_acccess_scores_obgyn", row.names = FALSE )
...
sf::st_write(
  ...
  c("dc_health_behavior_diet", "dmv_cttrbg_webmd_2021_acccess_scores_obgyn"),
